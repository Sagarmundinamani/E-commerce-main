...
const Footer = () => (
    <footer className="w-full text-white bg-[#212121]">
            ...
            <div className="flex-shrink-0 mx-auto text-center md:mx-0 md:text-left">
                ...
                <div className="mt-4 ">
                    <span className="inline-flex justify-center mt-2 sm:ml-3 sm:mt-0 sm:justify-start">
                        <a href="#" className="text-gray-500 cursor-pointer hover:text-blue" aria-label="Facebook">
                            <svg
                                fill="currentColor"
                                strokeLinecap="round"
                        ...
                        <a href="#" className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" aria-label="Twitter">
                            <svg
                                fill="currentColor"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                        ...
                        <a href="#" className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" aria-label="Instagram">
                            <svg
                                fill="none"
                                stroke="currentColor"
                                strokeLinecap="round"
                        ...
                        <a href="#" className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700" aria-label="LinkedIn">
                            <svg
                                fill="currentColor"
                                stroke="currentColor"
                                strokeLinecap="round"
            ...
            <div className="md:flex md:flex-wrap md:flex-grow grid grid-cols-2 mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                            <a href="#" className="cursor-pointer hover:underline underline-offset-4">
                                Company
                            </a>
                        </li>
                        <li className="mt-3">
        ...
        <div className="container px-5 pb-5 mx-auto text-center">
            <a href="https://www.linkedin.com/in/sagar-mundinamani-b103b327a/">
                <p className="text-md text-gray-700 capitalize xl:text-center">
                    © {new Date().getFullYear()} All rights reserved -sagar mundinamani
                </p>
            </a>
        </div>
    </footer>
